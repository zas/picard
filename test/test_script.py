...
class ScriptParserTest(PicardTestCase):
    ...
    def test_script_function_documentation_all(self):
        ...
        @script_function(documentation='somedoc1', examples=('example 1', 'example 2'))
    ...
    def test_script_function_documentation_all_html(self):
        ...
        @script_function(documentation='`$somefunc()`', examples=('*example 1*', 'example 2'))
        def func_somefunc(parser):
            return "x"
        ...
        self.assertEqual(docall, '<div id="test">'
            'w' + pre + '<code>$somefunc()</code>' + post + ''
            '<div class="examples">Examples:'
            '<div class="example">' + pre + '<em>example 1</em>' + post + '</div>'
            '<div class="example">' + pre + 'example 2' + post + '</div>'
            '</div>somefuncy</div>\n')
