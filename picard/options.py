...
BoolOption('setting', 'translate_from_sortname', False, title=N_("Use artist sort name for translation"))
...
TextOption('setting', 'selected_file_naming_script_id', '', title=N_("Active file naming script"))
