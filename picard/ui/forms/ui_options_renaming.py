...
class Ui_RenamingOptionsPage(object):
    def setupUi(self, RenamingOptionsPage):
        ...
        self.move_files_group = QtWidgets.QGroupBox(parent=RenamingOptionsPage)
        self.move_files_group.setObjectName("move_files_group")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.move_files_group)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.destination_directory_label = QtWidgets.QLabel(parent=self.move_files_group)
        ...
        self.move_files_to = QtWidgets.QLineEdit(parent=self.move_files_group)
        self.move_files_to.setObjectName("move_files_to")
        self.horizontalLayout_4.addWidget(self.move_files_to)
        self.move_files_to_browse = QtWidgets.QToolButton(parent=self.move_files_group)
        ...
        self.move_additional_files = QtWidgets.QCheckBox(parent=self.move_files_group)
        self.move_additional_files.setObjectName("move_additional_files")
        self.verticalLayout_4.addWidget(self.move_additional_files)
        self.move_additional_files_pattern = QtWidgets.QLineEdit(parent=self.move_files_group)
        ...
        self.delete_empty_dirs = QtWidgets.QCheckBox(parent=self.move_files_group)
        self.delete_empty_dirs.setObjectName("delete_empty_dirs")
        self.verticalLayout_4.addWidget(self.delete_empty_dirs)
        self.move_overwrite_existing_files = QtWidgets.QCheckBox(parent=self.move_files_group)
        ...
        self.verticalLayout_5.addWidget(self.move_files_group)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_5.addItem(spacerItem)
        self.help_layout = QtWidgets.QHBoxLayout()
        self.help_layout.setObjectName("help_layout")
        self.script_help_icon = QtWidgets.QLabel(parent=RenamingOptionsPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.script_help_icon.sizePolicy().hasHeightForWidth())
        self.script_help_icon.setSizePolicy(sizePolicy)
        self.script_help_icon.setObjectName("script_help_icon")
        self.help_layout.addWidget(self.script_help_icon)
        ...
        self.help_layout.addWidget(self.script_help_label)
        self.verticalLayout_5.addLayout(self.help_layout)
    ...
    def retranslateUi(self, RenamingOptionsPage):
        self.move_files_group.setTitle(_("When file moving is enabled:"))
        ...
        self.script_help_label.setText(_("Use the Options menu to enable or disable file renaming and moving, select the active naming script, or open the script editor."))
